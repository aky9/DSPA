...
Now, we will use Bayes, linear discriminant analysis, and decision trees to predict aforementioned health angina, strokes, and diabetes.
...
Across the board, a naive Bayes approach is successfully predicting incidences of medical complications with high True Positives and True Negatives. Lets look at linear discriminant analysis next. 
...
# Just making a function to pull need values from the confusion matricies
